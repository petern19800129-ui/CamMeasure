...
public class MainActivity extends Activity {
    ...
    private TextView latest, trend, rate, forecast, status, recent;
    ...
    @Override public void onCreate(Bundle b){
        ...
        repo=new DataRepository(this); buildUi(); loadLibra();
    }
    ...
    private void buildUi(){
        ...
        chart=new WeightChartView(this); chart.setForecastDays(forecastDays); root.addView(chart,new LinearLayout.LayoutParams(-1,dp(320)));
